        ...
        <div class="col-md-4 col-sm-12">
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('emirates.add') }}" class="form error" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    {{--<div class="col-12 mb-2">
                                        <div class="p-image mx-auto">
                                            <img id="imagePreview" src="{{asset('images/portrait/small/Default.png') }}">
                                    ...
                                    <div class="col-12">
                                        <div class="form-label-group">
                                            <input type="text" id="name" class="form-control" placeholder="Emirate" name="name" required="required">
                                            <label for="Name">Emirate</label>
                                        </div>
                                    </div>
                            ...
                            <table class="table zero-configuration table-striped">
                                ...
                                @foreach($Emirates as $row)
                                    <tr>
                                        <td>{{ $row->name }}</td>
                                        <td>
                                            <div data-id="{{ $row->id }}" data-model="{{ route('emirates.delete') }}" data-edit="{{ route('emirates.edit') }}"
                                                 data-name="{{ $row->name }}" data-pic="/storage/images/{{ $row->picname }}" class="action font-medium-2 d-flex">
...
@section('page-script')
    ...
    <script>
        ...
        $('.edit-record').click(function () {
            ...
            $('#imagePreview').attr("src",$(this).parent().data('pic'));
        ...
        $('#record-form :reset').click(function () {
            $('#imagePreview').attr("src","{{asset('images/portrait/small/Default.png') }}");
        ...
        $("#PicName").change(function () {
            ImagePreview(this,550000,['gif','png','jpg','jpeg','webp'],'#imagePreview');
        });
    </script>
@endsection
