...
@section('content')
    <div class="row">
        <div class="col-md-4 col-sm-12">
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('bedrooms.add') }}" class="form error" novalidate>
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-label-group">
                                            <input type="text" id="name" class="form-control" placeholder="Bedroom" name="name" required="required">
        ...
        <div class="col-md-8 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Bedrooms</h4>
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            ...
                            <table class="table zero-configuration table-striped">
                                ...
                                @foreach($Bedrooms as $row)
                                    <tr>
                                        <td>{{ $row->name }}</td>
                                        <td>
                                            <div data-id="{{ $row->id }}" data-model="{{ route('bedrooms.delete') }}" data-edit="{{ route('bedrooms.edit') }}"
