        ...
        <div class="col-md-4 col-sm-12">
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('villa-type.add') }}" class="form error" novalidate>
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="form-label-group">
                                            <input type="text" id="name" class="form-control" placeholder="Type" name="name" required="required">
                            ...
                            <table class="table zero-configuration table-striped truncate-table">
                                ...
                                @foreach($VillaTypes as $row)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $row->name }}</td>
                                        <td>
                                            <div data-id="{{ $row->id }}" data-model="{{ route('villa-type.delete') }}" data-edit="{{ route('villa-type.edit') }}" data-confirm="{{ route('villa-type.confirm') }}"
                                                 data-community="{{ $row->community->id }}" data-name="{{ $row->name }}" class="action font-medium-2 d-flex">
