...
@section('content')
    <div class="row">
        <div class="col-md-4 col-sm-12" style="padding-bottom: 2.2rem;">
            <div class="card h-100">
                <div class="card-header">
                    <h4 class="card-title">HR Access</h4>
                </div>
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('hr-access-setting') }}" class="form error" novalidate>
                            @csrf

                            @php
                                $hr_access_setting=\App\Models\Setting::where('id',16)->first();
                                $hr_access_setting_admin_id=\App\Models\SettingAdmin::where('setting_id',$hr_access_setting->id)->pluck('admin_id')->toArray();
                            @endphp
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <fieldset class="form-group form-label-group">
                                            <label for="hr_access_user">Included</label>
                                            <select class="form-control select2-checkbox" id="hr_access_user" name="hr_access_user[]">
                                                @php
                                                    $ClientManagers=\App\Models\Admin::where('company_id',$adminAuth->company_id)->where('status','1')->whereNotIn('type', [1,6,7,8])->orderBy('firstname','ASC')->get();
                                                @endphp
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('main-access-setting') }}" class="form error" novalidate>
                            @csrf
                            @php
                                $main_access_setting_admin_id=\App\Models\Admin::whereNull('main_super')->where('super',1)->pluck('id')->toArray();
                            @endphp
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('survey-access-setting') }}" class="form error" novalidate>
                            ...
                            @php
                                $survey_access_setting=\App\Models\Setting::where('id',19)->first();
        ...
        <div class="col-md-4 col-sm-12" style="padding-bottom: 2.2rem;">
            <div class="card h-100">
                <div class="card-header">
                    <h4 class="card-title">Leave Requests Controller</h4>
                </div>
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('request-approver-setting') }}" class="form error" novalidate>
                            @csrf

                            @php
                                $request_main_setting=\App\Models\Setting::where('id',22)->first();
                                $request_main_setting_admin_id=\App\Models\SettingAdmin::where('setting_id',$request_main_setting->id)->pluck('admin_id')->toArray();

                                $request_approver_setting=\App\Models\Setting::where('id',17)->first();
                                $request_approver_setting_admin_id=\App\Models\SettingAdmin::where('setting_id',$request_approver_setting->id)->pluck('admin_id')->toArray();
                            @endphp
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <fieldset class="form-group form-label-group">
                                            <label for="request_main_user">Decision Maker</label>
                                            <select class="form-control select2-checkbox" id="request_main_user" name="request_main_user[]">
                                                @php
                                    ...
                                    <div class="col-12">
                                        <fieldset class="form-group form-label-group">
                                            <label for="request_approver_user">Controller (Optional)</label>
                                            <select class="form-control select2-checkbox" id="request_approver_user" name="request_approver_user[]">
                                                @php
                                                    $ClientManagers=\App\Models\Admin::where('company_id',$adminAuth->company_id)->where('status','1')->orderBy('firstname','ASC')->get();
                                                @endphp
                                                @foreach($ClientManagers as $ClientManager)
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('open-lead-setting') }}" class="form error" novalidate>
                            ...
                            @php
                                $lead_setting=\App\Models\Setting::where('id',1)->first();
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="d-inline-block mb-2">
                                            <div class="custom-control custom-switch custom-switch-primary">
                                                <input type="checkbox" class="custom-control-input switch-a-d" data-input="lead" id="lead_switch" name="lead_switch" {{($lead_setting->status==1) ? 'checked' : ''}}>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-label-group">
                                                    <input type="text" id="lead_time" name="lead_time" class="form-control" placeholder="Counts" value="{{$lead_setting->time}}">
                            ...
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="d-inline-block mb-2">
                                            <div class="custom-control custom-switch custom-switch-primary">
                                                <input type="checkbox" class="custom-control-input switch-a-d" data-input="ma" id="ma_switch" name="ma_switch" {{($ma_setting->status==1) ? 'checked' : ''}}>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-label-group">
                                                    <input type="text" id="ma_time" name="ma_time" class="form-control" placeholder="Counts" value="{{$ma_setting->time}}">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('open-contact-activity-setting') }}" class="form error" novalidate>
                            ...
                            @php
                                $activity_contact_setting_1=\App\Models\Setting::where('id',7)->first();
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-10">
                                                <div class="form-label-group">
                                                    <input type="text" id="first_warning_time" name="first_warning_time" class="form-control" placeholder="Beginning" value="{{$activity_contact_setting_1->time}}" disabled>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-10">
                                                <div class="form-label-group">
                                                    <input type="text" id="second_warning_time" name="second_warning_time" class="form-control" placeholder="First Change" value="{{$activity_contact_setting_2->time}}">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-10">
                                                <div class="form-label-group">
                                                    <input type="text" id="third_warning_time" name="third_warning_time" class="form-control" placeholder="Second Change" value="{{$activity_contact_setting_3->time}}">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('open-expiration-property-setting') }}" class="form error" novalidate>
                            ...
                            @php
                                $expiration_property_setting_1=\App\Models\Setting::where('id',4)->first();
                                $expiration_property_setting_2=\App\Models\Setting::where('id',5)->first();
                                $expiration_property_setting_3=\App\Models\Setting::where('id',6)->first();
                            @endphp
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-10">
                                                <div class="form-label-group">
                                                    <input type="text" id="first_warning_time" name="first_warning_time" class="form-control" placeholder="First warning" value="{{$expiration_property_setting_1->time}}">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-10">
                                                <div class="form-label-group">
                                                    <input type="text" id="second_warning_time" name="second_warning_time" class="form-control" placeholder="Second warning" value="{{$expiration_property_setting_2->time}}">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-10">
                                                <div class="form-label-group">
                                                    <input type="text" id="third_warning_time" name="third_warning_time" class="form-control" placeholder="Third  warning" value="{{$expiration_property_setting_3->time}}">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('open-expiration-user-setting') }}" class="form error" novalidate>
                            ...
                            @php
                                $expiration_user_setting_1=\App\Models\Setting::where('id',13)->first();
                                $expiration_user_setting_2=\App\Models\Setting::where('id',14)->first();
                                $expiration_user_setting_3=\App\Models\Setting::where('id',15)->first();
                            @endphp
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-10">
                                                <div class="form-label-group">
                                                    <input type="text" id="first_warning_time" name="first_warning_time" class="form-control" placeholder="First warning" value="{{$expiration_user_setting_1->time}}">
                                                    <label for="first_warning_time">First Reminder (days in advance)</label>
                                                </div>
                                            </div>
                                            <div class="col-2 pt-1">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-10">
                                                <div class="form-label-group">
                                                    <input type="text" id="second_warning_time" name="second_warning_time" class="form-control" placeholder="Second warning" value="{{$expiration_user_setting_2->time}}">
                                                    <label for="second_warning_time">Second Reminder (days in advance)</label>
                                                </div>
                                            </div>
                                            <div class="col-2 pt-1">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-10">
                                                <div class="form-label-group">
                                                    <input type="text" id="third_warning_time" name="third_warning_time" class="form-control" placeholder="Third  warning" value="{{$expiration_user_setting_3->time}}">
                                                    <label for="third_warning_time">Third  Reminder (days in advance)</label>
                                                </div>
                                            </div>
                                            <div class="col-2 pt-1">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('calendar-color-setting') }}" class="form error" novalidate>
                            ...
                            @php
                                $calendar_viewing_setting=\App\Models\Setting::where('id',10)->first();
                                $calendar_appointment_setting=\App\Models\Setting::where('id',11)->first();
                                $calendar_reminder_setting=\App\Models\Setting::where('id',12)->first();
                                $calendar_cancelled_setting=\App\Models\Setting::where('id',18)->first();
                            @endphp
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-label-group form-group">
                                            ...
                                            <input type="text" id="viewing" name="viewing" class="form-control demo" value="{{$calendar_viewing_setting->value}}" data-control="hue">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-label-group form-group">
                                            <label for="cancelled">Cancelled</label>
                                            <input type="text" id="cancelled" name="cancelled" class="form-control demo" value="{{$calendar_cancelled_setting->value}}" data-control="hue">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-label-group form-group">
                                            <label for="viewing">Appointment</label>
                                            <input type="text" id="viewing" name="appointment" class="form-control demo" value="{{$calendar_appointment_setting->value}}" data-control="hue">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-label-group form-group">
                                            <label for="viewing">Reminder</label>
                                            <input type="text" id="appointment" name="reminder" class="form-control demo" value="{{$calendar_reminder_setting->value}}" data-control="hue">
                                        </div>
                                    </div>
                                    <div class="col-12" style="position: absolute;bottom: 20px;right: 10px">
                                        <button type="submit" class="btn btn-primary float-right" value="submit">Submit</button>
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('brochure-bg-setting') }}" class="form error" novalidate>
                            ...
                            @php
                                $brochure_bg_sale_setting=\App\Models\Setting::where('id',20)->first();
                                $brochure_bg_rent_setting=\App\Models\Setting::where('id',21)->first();
                            @endphp
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                       ...
                                       <div class="row">
                                           <div class="col-6">
                                               <div class="custom-control custom-radio" data-v-aa799a9e="">
                                                   <input type="radio" name="bg_sale" class="custom-control-input" value="bg-brochure-sale.jpg" id="sale_1" {{($brochure_bg_sale_setting->value=='bg-brochure-sale.jpg') ? 'checked' : ''}}>
                                                   <label class="custom-control-label" for="sale_1"> <img style="width: 100px;height: 30px" src="/images/bg-brochure-sale.jpg"> </label>
                                               </div>
                                           </div>
                                           <div class="col-6">
                                               <div class="custom-control custom-radio" data-v-aa799a9e="">
                                                   <input type="radio" name="bg_rent" class="custom-control-input" value="bg-brochure-rent.jpg" id="rent_1" {{($brochure_bg_rent_setting->value=='bg-brochure-rent.jpg') ? 'checked' : ''}}>
                                    ...
                                    <div class="col-12 mt-1">
                                       <div class="row">
                                           <div class="col-6">
                                               <div class="custom-control custom-radio" data-v-aa799a9e="">
                                                   <input type="radio" name="bg_sale" class="custom-control-input" value="bg-brochure-sale-2.jpg" id="sale_2" {{($brochure_bg_sale_setting->value=='bg-brochure-sale-2.jpg') ? 'checked' : ''}}>
                                                   <label class="custom-control-label" for="sale_2"> <img style="width: 100px;height: 30px" src="/images/bg-brochure-sale-2.jpg"> </label>
                                               </div>
                                           </div>
                                           <div class="col-6">
                                               <div class="custom-control custom-radio" data-v-aa799a9e="">
                                                   <input type="radio" name="bg_rent" class="custom-control-input" value="bg-brochure-rent-2.jpg" id="rent_2" {{($brochure_bg_rent_setting->value=='bg-brochure-rent-2.jpg') ? 'checked' : ''}}>
                                    ...
                                    <div class="col-12 mt-1">
                                       <div class="row">
                                           <div class="col-6">
                                               <div class="custom-control custom-radio" data-v-aa799a9e="">
                                                   <input type="radio" name="bg_sale" class="custom-control-input" value="bg-brochure-sale-3.jpg" id="sale_3" {{($brochure_bg_sale_setting->value=='bg-brochure-sale-3.jpg') ? 'checked' : ''}}>
                                                   <label class="custom-control-label" for="sale_3"> <img style="width: 100px;height: 30px" src="/images/bg-brochure-sale-3.jpg"> </label>
                                               </div>
                                           </div>
                                           <div class="col-6">
                                               <div class="custom-control custom-radio" data-v-aa799a9e="">
                                                   <input type="radio" name="bg_rent" class="custom-control-input" value="bg-brochure-rent-3.jpg" id="rent_3" {{($brochure_bg_rent_setting->value=='bg-brochure-rent-3.jpg') ? 'checked' : ''}}>
                                    ...
                                    <div class="col-12 mt-1">
                                       <div class="row">
                                           <div class="col-6">
                                               <div class="custom-control custom-radio" data-v-aa799a9e="">
                                                   <input type="radio" name="bg_sale" class="custom-control-input" value="bg-brochure-sale-4.jpg" id="sale_4" {{($brochure_bg_sale_setting->value=='bg-brochure-sale-4.jpg') ? 'checked' : ''}}>
                                                   <label class="custom-control-label" for="sale_4"> <img style="width: 100px;height: 30px" src="/images/bg-brochure-sale-4.jpg"> </label>
                                               </div>
                                           </div>
                                           <div class="col-6">
                                               <div class="custom-control custom-radio" data-v-aa799a9e="">
                                                   <input type="radio" name="bg_rent" class="custom-control-input" value="bg-brochure-rent-4.jpg" id="rent_4" {{($brochure_bg_rent_setting->value=='bg-brochure-rent-4.jpg') ? 'checked' : ''}}>
                                    ...
                                    <div class="col-12 mt-1">
                                       <div class="row">
                                           <div class="col-6">
                                               <div class="custom-control custom-radio" data-v-aa799a9e="">
                                                   <input type="radio" name="bg_sale" class="custom-control-input" value="bg-brochure-sale-5.jpg" id="sale_5" {{($brochure_bg_sale_setting->value=='bg-brochure-sale-5.jpg') ? 'checked' : ''}}>
                                                   <label class="custom-control-label" for="sale_5"> <img style="width: 100px;height: 30px" src="/images/bg-brochure-sale-5.jpg"> </label>
                                               </div>
                                           </div>
                                           <div class="col-6">
                                               <div class="custom-control custom-radio" data-v-aa799a9e="">
                                                   <input type="radio" name="bg_rent" class="custom-control-input" value="bg-brochure-rent-5.jpg" id="rent_5" {{($brochure_bg_rent_setting->value=='bg-brochure-rent-5.jpg') ? 'checked' : ''}}>
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('open-buyer-tenant-setting') }}" class="form error" novalidate>
                            ...
                            @php
                                $buyer_tenant_setting=\App\Models\Setting::where('id',3)->first();
                            ...
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="d-inline-block mb-2">
                                            <div class="custom-control custom-switch custom-switch-primary">
                                                <input type="checkbox" class="custom-control-input switch-a-d" data-input="buyer_tenant" id="buyer_tenant_switch" name="buyer_tenant_switch" {{($buyer_tenant_setting->status==1) ? 'checked' : ''}}>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-label-group">
                                                    <input type="text" id="buyer_tenant_time" name="buyer_tenant_time" class="form-control" placeholder="Counts" value="{{$buyer_tenant_setting->time}}">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('upload-contact-setting') }}" class="form error" novalidate>
                            ...
                            @php
                                $upload_contact_setting=\App\Models\Setting::where('id',23)->first();
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('task-access-setting') }}" class="form error" novalidate>
                            ...
                            @php
                                $task_access_setting=\App\Models\Setting::where('id',24)->first();
                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <input type="checkbox" class="checkbox" name="status" value="1" {{ ($task_access_setting->status=='1') ? 'checked':'' }}> User Own Task
                                    </div>
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary float-right" value="submit">Submit</button>
                                    </div>
...
@section('page-script')
    ...
    <script>
        ...
        $(document).ready(function(){
            $('#ma_switch').change();
            $('#ma_time_type').val({{$ma_setting->time_type}});
            $('#ma_user').val([{{join(',',$ma_setting_admin_id)}}]).change();


            $('#lead_switch').change();
            $('#lead_time_type').val({{$lead_setting->time_type}});
            ...
            $('#buyer_tenant_time_type').val({{$buyer_tenant_setting->time_type}});
        ...
        $(document).ready( function() {
            ...
            $('.demo').each( function() {
                ...
                $(this).minicolors({
                    ...
                    defaultValue: $(this).attr('da ta-defaultValue') || '',
