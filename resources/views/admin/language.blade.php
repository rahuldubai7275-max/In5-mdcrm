        ...
        <div class="col-md-4 col-sm-12">
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('language.add') }}" class="form error" novalidate>
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-label-group">
                                            <input type="text" id="name" class="form-control" placeholder="Language" name="name" required="required">
                            ...
                            <table class="table zero-configuration table-striped">
                                ...
                                @foreach($languages as $row)
                                    <tr>
                                        <td>{{ $row->name }}</td>
                                        <td>
                                            <div data-id="{{ $row->id }}" data-model="{{ route('language.delete') }}" data-edit="{{ route('language.edit') }}"
