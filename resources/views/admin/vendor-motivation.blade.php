...
@section('title', 'Vendor Motivation')
...
@section('content')
    <div class="row">
        <div class="col-md-4 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Vendor Motivation</h4>
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('vendor-motivation.add') }}" class="form error" novalidate>
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-label-group">
                                            <input type="text" id="name" class="form-control" placeholder="Vendor Motivation" name="name" required="required">
                                            <label for="Name">Vendor Motivation</label>
                                        </div>
                                    </div>
                                    <div class="col-12 record-action-box">
                                        ...
                                        <div class="update-btn-box float-right d-none">
                                            ...
                                            <button type="submit" class="btn btn-primary mb-1" name="update" value="submit">Update</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-md-8 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Vendor Motivation</h4>
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table zero-configuration table-striped">
                                ...
                                <tbody>
                                @foreach($VendorMotivations as $row)
                                    <tr>
                                        <td>{{ $row->name }}</td>
                                        <td>
                                            <div data-id="{{ $row->id }}" data-model="{{ route('vendor-motivation.delete') }}" data-edit="{{ route('vendor-motivation.edit') }}"
