...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Master Project</h4>
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('master-project.add') }}" class="form error" novalidate>
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="form-label-group">
                                            <input type="text" id="name" class="form-control" placeholder="Master Project" name="name" required="required">
                                            <label for="Name">Master Project</label>
                                        </div>
                                    </div>
        ...
        <div class="col-md-{{($adminAuth->type==1) ? '8':'12'}} col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Master Project</h4>
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            ...
                            <table class="table zero-configuration table-striped">
                                ...
                                @foreach($MasterProjects as $row)
                                    <tr>
                                        ...
                                        <td>
                                            @if($adminAuth->type==1)
                                            <div data-id="{{ $row->id }}" data-model="{{ route('master-project.delete') }}" data-edit="{{ route('master-project.edit') }}"
                                                 data-name="{{ $row->name }}" data-emirate="{{ $row->emirate_id }}" class="action font-medium-2 d-flex">
...
@section('page-script')
    ...
    <script>
        ...
        $('.edit-record').click(function () {
            ...
            $('#emirate').val($(this).parent().data('emirate'));
