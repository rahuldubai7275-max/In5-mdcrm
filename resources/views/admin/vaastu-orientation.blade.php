...
@section('title', 'Vaastu Orientation')
...
@section('content')
    <div class="row">
        <div class="col-md-4 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Vaastu Orientation</h4>
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('vaastu-orientation.add') }}" class="form error" novalidate>
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-label-group">
                                            <input type="text" id="name" class="form-control" placeholder="Vaastu Orientation" name="name" required="required">
                                            <label for="Name">Vaastu Orientation</label>
                                        </div>
                                    </div>
        ...
        <div class="col-md-8 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Vaastu Orientation</h4>
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table zero-configuration table-striped">
                                ...
                                <tbody>
                                @foreach($VaastuOrientations as $row)
                                    <tr>
                                        <td>{{ $row->name }}</td>
                                        <td>
                                            <div data-id="{{ $row->id }}" data-model="{{ route('vaastu-orientation.delete') }}" data-edit="{{ route('vaastu-orientation.edit') }}"
