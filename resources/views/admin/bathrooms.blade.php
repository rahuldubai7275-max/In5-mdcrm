        ...
        <div class="col-md-4 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Bathroom</h4>
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form id="record-form" method="post" action="{{ route('bathrooms.add') }}" class="form error" novalidate>
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-label-group">
                                            <input type="text" id="name" class="form-control" placeholder="Bathroom" name="name" required="required">
                            ...
                            <table class="table zero-configuration table-striped">
                                ...
                                @foreach($Bathrooms as $row)
                                    <tr>
                                        <td>{{ $row->name }}</td>
                                        <td>
                                            <div data-id="{{ $row->id }}" data-model="{{ route('bathrooms.delete') }}" data-edit="{{ route('bathrooms.edit') }}"
