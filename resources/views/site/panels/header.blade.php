<!-- Main Header Nav -->
<header class="header-nav @yield('header-style') menu_style_home_one navbar-scrolltofixed stricky main-menu">
    <div class="container-fluid p0">
        <!-- Ace Responsive Menu -->
        <nav>
            <!-- Menu Toggle btn-->
            <div class="menu-toggle">
                <!--<img class="nav_logo_img img-fluid" src="/images/vuexy-logo.png" alt="header-logo.png">-->
            ...
            <a href="/" class="navbar_brand float-left dn-smd">
                <!--<img style="width: 100px;" class="logo1 img-fluid" src="/images/vuexy-logo.png" alt="header-logo.png">-->
                <!--<img style="width: 100px;" class="logo2 img-fluid" src="/images/vuexy-logo.png" alt="header-logo2.png">-->
                <!--<span>LUXLIVING</span>-->
            </a>
...
{{--style2 scroll-to-fixed-fixed slideIn animated--}}
<!-- Main Header Nav For Mobile -->
<div id="page" class="stylehome1 h0">
    <div class="mobile-menu">
        <div class="header stylehome1">
            <div class="main_logo_home2 text-center">
                <!--<img class="nav_logo_img img-fluid mt20"  style="width: 100px;" src="/images/vuexy-logo.png" alt="header-logo2.png">-->
